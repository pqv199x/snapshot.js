            ...
            switch (_a.label) {
                ...
                case 3:
                    ...
                    stakedTDAO = stakedLPBalances.returnData.map(function (stakedBalance, index) {
                        return new BN(lpBalances.returnData[index].substr(2), 16).add(new BN(stakedBalance.substr(2), 16)).mul(new BN(pairsInfo.pairs[0].reserve0)).div(new BN(pairsInfo.pairs[0].totalSupply)).div(new BN("1000000000000000000"));
                    });
